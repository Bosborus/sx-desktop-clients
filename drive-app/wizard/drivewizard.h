...
#ifndef DRIVEWIZARD_H
#define DRIVEWIZARD_H

#include "wizard/sxwizard.h"
#include "sxconfig.h"
#include "wizardchoosevolumepage.h"

class DriveWizard : public SxWizard
{
    Q_OBJECT
public:
    DriveWizard(SxConfig *config, QWidget *parent = 0);
...
private:
    void restoreSetings(SxConfig *config);
    void saveSettings();

private:
    SxConfig *m_config;
    QHash<QString, QString> mSelectedVolumes;
    WizardChooseVolumePage *mVolumePage;
};
