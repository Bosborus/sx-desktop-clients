...
QString formatSize(qint64 size, int precision=-1);
...
QString encodeSxUrl(QString url);
QString deriveKey(const QString &sx_username, const QString &sx_password, const QString &sx_uuid, uint iterations=12);
